/* ============================================================
   사도행전 본문 (개역개정) — 앱 내 말씀 검색용 데이터
   ACTS_TEXT[장][절] = 절 본문 (문자열 키)
   28장 1006절 — 개역개정에는 24:7이 없다(사본상 생략).
   ============================================================ */
window.ACTS_TEXT = {
  "1": {
  ...
  "15": {
    ...
    "26": "사람을 택하여 우리 주 예수 그리스도의 이름을 위하여 생명을 아끼지 아니하는 자인 우리가 사랑하는 바나바와 바울과 함께 너희에게 보내기를 만장일치로 결정하였노라",
